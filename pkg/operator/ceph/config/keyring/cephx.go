...
// Optional: and entity ID prefix can be provided to filter results to only entities with the
// prefix. For example, for mds, use the filesystem name plus a hyphen (e.g., "myfs-") to narrow
// results to the current CephFilesystem.
